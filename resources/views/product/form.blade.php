                ...
                <div class="card-body">
                    ...
                    <form id="form" action="{{ $action }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="mb-3">
                            ...
                            <div class="dropzone dz-clickable border rounded bg-light d-flex align-items-center justify-content-center p-3" id="photos-dropzone">
    ...
    var myDropzonePhotos = new Dropzone("#photos-dropzone", {
        ...
        init: function() {
            ...
            existingFiles.forEach(function(file) {
                var mockFile = { name: file.name, size: file.size, type: file.type, accepted: true };
                dropzoneInstance.emit("addedfile", mockFile);
                dropzoneInstance.emit("thumbnail", mockFile, file.url);
                dropzoneInstance.files.push(mockFile);
                dropzoneInstance.emit("complete", mockFile);
                $('#form').append('<input type="hidden" name="photos_old[]" value="' + file.data + '" longName="' + file.name + '">')
            });
        },
        headers: {
